...
def try_import_or_install(package):
    try:
        print(f"[GAME] Trying to import {package}")
        __import__(package)
        print(f"[GAME] {package} has been imported")
    except ImportError:
        print(f"[EXCEPTION] {package} not installed")
        print(f"[GAME] Trying to install {package} via pip")
        try:
            install(package)
            print(f"[GAME] {package} has been installed")
        except Exception as e:
            print(f"[ERROR 1] {package} could not be installed. Error: {e}")

try_import_or_install("pygame")
